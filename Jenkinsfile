...
node {
    ...
    def HUB_ORG=env.HUB_ORG_QA
    def SFDC_HOST = env.SFDC_HOST_QA
    def JWT_KEY_CRED_ID = env.JWT_CRED_ID_QA
    def CONNECTED_APP_CONSUMER_KEY=env.CONNECTED_APP_CONSUMER_KEY_QA
